...
const Navbar = () => {
  ...
  return (
    <div className="absolute w-full flex justify-between p-4 items-center">
      <h1 className="text-white font-bold text-3xl z-20 drop-shadow-lg cursor-pointer">
        <span>iCe</span>Travels
      </h1>
      <HiMenuAlt3
        onClick={handleNav}
      ...
      <div
        className={
          nav
            ? "ease-in duration-300 fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 py-7 flex-col z-10"
